...
import { Smile, ChevronLeft, ChevronRight, Calendar } from "lucide-react"
            ...
            <div className="space-y-4">
              <div className="rounded-lg border p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  You've been feeling mostly happy and calm this month. Your partner has been experiencing more stress
                  than usual. Consider planning a relaxing activity together this weekend.
                </p>
              </div>
              ...
              <div className="rounded-lg border p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  You both felt loved on the same days when you spent quality time together. Try to schedule more date
                  nights or shared activities to strengthen your connection.
                </p>
              </div>
